...
class Setting extends CI_Controller
{
    ...
    public function upload_avatar()
    {
        ...
        $this->template->load('template', 'upload_avatar_profile_form', $data);
    }
    ...
    public function edit_profile()
    {
        ...
        if ($this->input->method() === 'post') {
            ...
            if ($this->form_validation->run() === FALSE) {
                return $this->template->load('template', 'edit_profile_form.php', $data);
            }
        ...
        $this->template->load('template', 'edit_profile_form.php', $data);
    }
    ...
    public function edit_password()
    {
        ...
        if ($this->input->method() === 'post') {
            ...
            if ($this->form_validation->run() === FALSE) {
                return $this->template->load('template', 'edit_password_form.php', $data);
            }
        ...
        $this->template->load('template', 'edit_password_form.php', $data);
    }
}
