<section class="content">
    <div class="container-fluid">
        ...
        <div class="toolbar my-3">
            <a href="<?= site_url('admin/setup_location/input_setup_location') ?>" class="btn btn-primary" role="button" data-bs-toggle="button">+ SetUp Home</a>
        </div>
        <div class="card">
                ...
                <table class="table table-striped projects">
                    ...
                    <tbody>
                        <?php foreach ($setups as $setup) : ?>
                            <tr>
                                <td> <img src="<?= base_url() . '/upload/hero/' . $setup->hero_img_1 ?>" alt="" style="width: 8rem;">
                                ...
                                <td class="project-actions text-center">
                                    <a class="btn btn-primary btn-sm" target="_blank" href="<?= site_url('home/locations') ?>">
                                        <i class="fas fa-eye">
                                        </i>
                                        View
                                    </a>
                                    <a class="btn btn-info btn-sm my-2" href="<?= site_url('admin/setup_location/edit_setup_location/' . $setup->id_location) ?>">
                                        <i class="fas fa-pencil-alt">
                                        </i>
                                        Edit
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="#" data-delete-url="<?= site_url('admin/setup_location/delete/' . $setup->id_location) ?>" onclick="deleteConfirm(this)">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Setup Content Section Ke-2</h3>
            </div>
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    <thead>
...
<div class="modal fade" id="modal-lg">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= site_url('admin/setup_location/edit_hero_story_1/' . $setup->id_location) ?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
...
<div class="modal fade" id="modal-lg-2">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= site_url('admin/setup_location/edit_hero_story_2/' . $setup->id_location) ?>" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>Pilih Foto Produk</label><br>
