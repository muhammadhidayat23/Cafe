    ...
    <div class="container-fluid">
        <div class="card card-primary my-3">
            <div class="card-header">
                <h3 class="card-title">Form Tambah Data Setup Halaman Contact</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="32" class="form-control" name="title" placeholder="Masukkan Title, maksimal 5 kata">
                    </div>
                    <div class="form-group form-floating">
                        <label for="floatingTextarea">Deskripsi</label>
                        <textarea type="text" maxlength="132" class="form-control" name="deskripsi" placeholder="Masukkan Deskripsi, maksimal 20 kata" id="floatingTextarea"></textarea>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>Hero Images 1</label><br>
                            <input type="file" accept="image/*" name="hero_img_1" id="preview_gambar" required="required">
                        </div>
                        <div class="form-group col-sm-6 text-center">
                            <label>Preview Images</label><br>
                            <img src="<?= base_url('assets/images/no-image.jpg') ?>" id="load_gambar" style="width: 30%;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label>Hero Images 2</label><br>
