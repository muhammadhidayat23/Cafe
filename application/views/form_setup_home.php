    ...
    <div class="container-fluid">
        <div class="card card-primary my-3">
            <div class="card-header">
                <h3 class="card-title">Form Tambah Setup Hero Halaman Home</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="32" class="<?= form_error('title') ? 'invalid' : '' ?> form-control" name="title" placeholder="Masukkan Title, maksimal 8 kata" value="<?= set_value('title') ?>">
