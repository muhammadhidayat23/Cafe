<section class="content">
    <div class="container-fluid">
                        ...
                        <?php foreach ($setups as $setup) : ?>
                            <tr>
                                ...
                                <td class="project-actions text-center">
                                    <a class="btn btn-primary btn-sm" target="_blank" href="<?= site_url('home/location') ?>">
                                        <i class="fas fa-eye">
                                        </i>
                                        View
                                    </a>
                                    <a class="btn btn-info btn-sm my-2" href="<?= site_url('admin/setup_menu/edit_setup_menu/' . $setup->id_location) ?>">
                                        <i class="fas fa-pencil-alt">
                                        </i>
                                        Edit
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="#" data-delete-url="<?= site_url('admin/setup_menu/delete/' . $setup->id_location) ?>" onclick="deleteConfirm(this)">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Setup Content Location Ke-2</h3>
            </div>
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    <thead>
